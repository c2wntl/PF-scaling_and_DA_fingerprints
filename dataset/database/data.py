...
"""
This file is taken from the developer of 2DMD dataset.
Please visit https://github.com/AIRI-Institute/2DMD_at_a_Glance
"""
    ...
    try:
        with tarfile.open(structures_tar, "r:gz") as tar:
            for member in tqdm(tar.getmembers()):
                ...
                this_structure_file = pymatgen.io.cif.CifParser.from_str(tar.extractfile(member).read().decode("ascii"))
